...
const App = {
  ...
  exchange: async function (){
    ...
    //const name = document.getElementById("starName").value;
    const id1 = document.getElementById("exchangeId1").value;
    const id2 = document.getElementById("exchangeId2").value;
    await exchangeStars(id1, id2).send({from: this.account});
    App.setStatus("You exchanged stars " + id1+ " and "+ id2 +" Sucessfully" + ".");
  }
